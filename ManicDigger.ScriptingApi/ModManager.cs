...
namespace ManicDigger
{
	public interface ModManager
	{
		...
		/// <summary>
		/// Registers a method to be called when any entity is updated
		/// </summary>
		/// <param name="f">Function to register. Required parameters: (ServerEntityId id)</param>
		void RegisterOnEntityUpdate(ModDelegates.EntityUpdate f);

		/// <summary>
		/// Registers a method to be called every time a player interacts with an entity
		/// </summary>
		/// <param name="f">Function to register. Required parameters: (int player, ServerEntityId id)</param>
		void RegisterOnEntityUse(ModDelegates.EntityUse f);

		/// <summary>
		/// Registers a method to be called every time a player hits an entity
		/// </summary>
		/// <param name="f">Function to register. Required parameters: (int player, ServerEntityId id)</param>
		void RegisterOnEntityHit(ModDelegates.EntityHit f);

		/// <summary>
		/// Registers a handler for player input in dialogs
		/// </summary>
		/// <param name="a">Function to register. Required Parameters: (DialogClickArgs args)</param>
		void RegisterOnDialogClick2(ModDelegates.DialogClick2 a);

		/// <summary>
		/// Create a new persistent entity on the server.
		/// A position must be given for the entity.
		/// </summary>
		/// <param name="entity">The entity to spawn</param>
		/// <returns>An entity ID which can be used to access the entity</returns>
		ServerEntityId EntityCreate(ServerEntity entity);

		/// <summary>
		/// Retrieves an entity by its unique ID
		/// </summary>
		/// <param name="id">The ID of the entity to fetch</param>
		/// <returns><see cref="ServerEntity"/> associated with the given ID</returns>
		ServerEntity EntityGet(ServerEntityId id);

		/// <summary>
		/// Marks an entity as "dirty" so it is updated for all clients.
		/// </summary>
		/// <param name="id">The ID of the entity to update</param>
		void EntitySetDirty(ServerEntityId id);

		/// <summary>
		/// Permanently delete an entity by its unique ID.
		/// </summary>
		...
		[Obsolete("RegisterOnDialogClick is deprecated, please use RegisterOnDialogClick2 instead.", false)]
	...
	public class ModDelegates
	{
		...
		public delegate void EntityUpdate(ServerEntityId id);
		public delegate void EntityUse(int player, ServerEntityId id);
		public delegate void EntityHit(int player, ServerEntityId id);
