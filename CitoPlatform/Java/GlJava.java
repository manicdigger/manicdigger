...
public class GlJava extends Gl
{
	...
	@Override
	public void bufferData2(int target, ArrayBufferView data, int usage)
	{
	}

	@Override
	public void bufferData3(int target, ArrayBuffer data, int usage)
	{
	}
	...
	@Override
	public void bufferSubData1(int target, int offset, ArrayBufferView data)
	{
	}

	@Override
	public void bufferSubData2(int target, int offset, ArrayBuffer data)
	{
	}
	...
	@Override
	public GlObject getProgramParameter(WebGLProgram program, int pname)
	{
		return null;
	}
