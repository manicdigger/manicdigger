	...
	public class WarBlocks : IMod
	{
		...
		public void Start(ModManager m)
		{
			...
			m.SetBlockType(154, "Pistol", new BlockType()
			{
				...
				HarverstabilityMask = 15,
				IronSightsFov = 0.8f,
				HarvestabilityMask = 12,
				AmmoTotal = 120,
				ReloadDelay = 2,
				ExplosionRange = 0.2f,
				ExplosionTime = 0.2f,
			...
			m.SetBlockType(155, "SubmachineGun", new BlockType()
			{
				...
				HarverstabilityMask = 20,
				IronSightsFov = 0.8f,
				HarvestabilityMask = 30,
				AmmoTotal = 120,
				ReloadDelay = 2,
				ExplosionRange = 0.2f,
				ExplosionTime = 0.2f,
			...
			m.SetBlockType(157, "Rifle", new BlockType()
			{
				...
				HarverstabilityMask = 10,
				IronSightsFov = 0.5f,
				HarvestabilityMask = 6,
				AmmoTotal = 48,
				ReloadDelay = 2,
				ExplosionRange = 0.2f,
				ExplosionTime = 0.2f,
