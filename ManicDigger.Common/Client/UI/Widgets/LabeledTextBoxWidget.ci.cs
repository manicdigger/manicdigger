public class LabeledTextBoxWidget : AbstractMenuWidget
{
    TextWidget _text;
    TextWidget _label;
    FontCi _inputFont;
	...
	public LabeledTextBoxWidget()
	{
        ...
        _label.SetFont(_inputFont);
        _label.SetAlignment(TextAlign.Left);
        _label.SetBaseline(TextBaseline.Middle);
        _label.SetText(  "Input");
    }
	...
	public override void Draw(float dt, UiRenderer renderer)
	{
		...
		renderer.Draw2dTexture(renderer.GetTexture(hasKeyboardFocus ? _textureNameActive : _textureNameInactive), x+sizex/2, y, sizex/2, sizey, null, 0, color);
