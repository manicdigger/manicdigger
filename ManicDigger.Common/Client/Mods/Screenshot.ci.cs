public class ModScreenshot : ClientMod
{
	...
	{
		game.rend.Draw2dTexture(game.rend.WhiteTexture(), 0, 0, game.platform.GetCanvasWidth(), game.platform.GetCanvasHeight(), null, 0, ColorCi.FromArgb(255, 255, 255, 255), false);
		...
		game.rend.Draw2dText(screenshottext, font, game.xcenter(textWidth.value), game.ycenter(textHeight.value), null, false);
	}
