public class ModScreenshot : ClientMod
{
	...
	{
		game.rend.Draw2dTexture(game.WhiteTexture(), 0, 0, game.platform.GetCanvasWidth(), game.platform.GetCanvasHeight(), null, 0, ColorCi.FromArgb(255, 255, 255, 255), false);
