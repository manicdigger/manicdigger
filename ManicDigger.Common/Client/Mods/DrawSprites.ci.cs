public class ModDrawSprites : ClientMod
{
	public override void OnNewFrameDraw3d(Game game, float deltaTime)
	{
		...
		for (int i = 0; i < game.entitiesCount; i++)
		{
			...
			game.rend.GLTranslate(b.positionX, b.positionY, b.positionZ);
			Billboard(game);
			game.rend.GLScale((one * 2 / 100), (one * 2 / 100), (one * 2 / 100));
			game.rend.GLTranslate(0 - b.size / 2, 0 - b.size / 2, 0);
			...
			game.rend.Draw2dTexture(game.GetTexture(b.image), 0, 0, b.size, b.size, n, b.animationcount, ColorCi.FromArgb(255, 255, 255, 255), true);
	...
	{
		float[] m = game.rend.mvMatrix.Peek();
