...
mono CiTo.exe -D CITO -D JS -D JSTA -l js-ta -o cito/output/JsTa/ManicDigger.js $(ls ManicDiggerLib/Client/*.ci.cs) $(ls ManicDiggerLib/Client/Mods/*.ci.cs) $(ls ManicDiggerLib/Client/MainMenu/*.ci.cs) $(ls ManicDiggerLib/Client/Misc/*.ci.cs) $(ls ManicDiggerLib/Client/SimpleServer/*.ci.cs) $(ls ManicDiggerLib/Client/UI/*.ci.cs) $(ls ManicDiggerLib/Client/UI/Screens/*.ci.cs) $(ls ManicDiggerLib/Common/*.ci.cs) Packet.Serializer.ci.cs
