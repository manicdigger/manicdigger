        ...
        private void DrawCraftingRecipes()
        {
            ...
            for (int i = 0; i < okrecipes.Count; i++)
            {
                ...
                for (int ii = 0; ii < r.IngredientsCount; ii++)
                {
                    ...
                    Draw2dTexture(d_TerrainTextures.terrainTexture, xx, yy, 30, 30, game.TextureIdForInventory[r.Ingredients[ii].Type]);
                ...
                }
                {
                    ...
                    int yy = menustarty + i * 80;
                    Draw2dTexture(d_TerrainTextures.terrainTexture, xx, yy, 40, 40, game.TextureIdForInventory[r.Output.Type]);
