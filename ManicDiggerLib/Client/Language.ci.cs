public class Language
{
    ...
    void AddEnglish()
    {
        ...
        Add("en", "Server_CommandBanMessage", "{0}{1} was banned by {2}.{3}");
        Add("en", "Server_CommandBanNotification", "You were banned by an administrator.{0}");
        Add("en", "Server_CommandIPBanMessage", "{0}{1} was IP banned by {2}.{3}");
        Add("en", "Server_CommandIPBanNotification", "You were IP banned by an administrator.{0}");
